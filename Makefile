...
programa.o: src/programa.c include/programa.h
	$(CC) -c -o $@ -I $(INCDIR) $(CFLAGS) $<

processo.o: src/processo.c include/processo.h include/programa.h
	$(CC) -c -o $@ -I $(INCDIR) $(CFLAGS) $<

tabela.o: src/tabela.c include/tabela.h include/processo.h
	$(CC) -c -o $@ -I $(INCDIR) $(CFLAGS) $<
